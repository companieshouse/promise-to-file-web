...
import healthcheckRoute from "../controllers/healthcheck.controller";
...
router.get(pageURLs.WARNING, warningRoute);
...
router.get(pageURLs.HEALTHCHECK, healthcheckRoute);
