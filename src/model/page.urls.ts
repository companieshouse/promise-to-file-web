...
export const REPEAT_APPLICATION = COMPANY_AUTH_PROTECTED_ROUTE + Templates.REPEAT_APPLICATION;
...
export const COMPANY_REQUIRED_REPEAT_APPLICATION: string = COMPANY_REQUIRED + REPEAT_APPLICATION;
